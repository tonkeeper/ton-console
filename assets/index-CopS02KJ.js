import{j as e,aA as y,aB as h,aC as u,aD as g,aE as L,aF as j,C as m,G as I,T as a,F as o,B as v,a2 as S,a3 as k,a7 as f,a8 as C,a9 as B,a5 as w,aG as E,b,b$ as N,aM as A,E as _,l as M,O as F,k as O,bn as X,L as T,bm as z,d as D,c0 as R}from"./index-BCN26Ft_.js";import{e as K,f as P,c as q}from"./queries-DS3Ag-C4.js";import{a as Z}from"./queries-Bhlsj0k-.js";import{E as J}from"./index-Cix0b3hi.js";const x=t=>{const s=new Date(t);return`${s.toLocaleDateString()} ${s.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}`},W=({isOpen:t,onClose:s})=>{const{data:i,isLoading:d}=Z();return d?e.jsxs(y,{isOpen:t,onClose:s,size:"4xl",children:[e.jsx(h,{}),e.jsxs(u,{children:[e.jsx(g,{children:"Liteproxy Statistics"}),e.jsx(L,{}),e.jsx(j,{children:e.jsx(m,{h:"400px",children:e.jsx(I,{})})})]})]}):i?e.jsxs(y,{isOpen:t,onClose:s,size:"4xl",children:[e.jsx(h,{}),e.jsxs(u,{children:[e.jsx(g,{children:"Liteproxy Statistics"}),e.jsx(L,{}),e.jsx(j,{pb:4,children:e.jsxs(o,{direction:"column",gap:8,children:[e.jsx(a,{textStyle:"text.label1",mb:1,color:"text.secondary",fontSize:16,children:"Liteproxy Requests"}),e.jsx(v,{h:250,children:e.jsx(S,{height:"100%",children:e.jsxs(k,{data:i.requests,margin:{left:0,right:0},children:[e.jsx(f,{dataKey:"time",type:"number",domain:["dataMin","dataMax"],tickFormatter:x}),e.jsx(C,{}),e.jsx(B,{labelFormatter:n=>x(Number(n))}),e.jsx(w,{type:"monotone",dataKey:"value",stroke:"#2E84E5",dot:!1,isAnimationActive:!1})]})})}),e.jsx(a,{textStyle:"text.label1",mb:1,color:"text.secondary",fontSize:16,children:"Liteproxy Connections"}),e.jsx(v,{h:250,children:e.jsx(S,{height:"100%",children:e.jsxs(k,{data:i.connections,margin:{left:0,right:0},children:[e.jsx(f,{dataKey:"time",type:"number",domain:["dataMin","dataMax"],tickFormatter:x}),e.jsx(C,{}),e.jsx(B,{labelFormatter:n=>x(Number(n))}),e.jsx(w,{type:"monotone",dataKey:"value",stroke:"#52A02B",dot:!1,isAnimationActive:!1})]})})})]})})]})]}):e.jsxs(y,{isOpen:t,onClose:s,size:"4xl",children:[e.jsx(h,{}),e.jsxs(u,{children:[e.jsx(g,{children:"Liteproxy Statistics"}),e.jsx(L,{}),e.jsx(j,{children:e.jsx(m,{h:"400px",children:e.jsx(a,{color:"text.secondary",children:"No data available"})})})]})]})},G=t=>{const{mutate:s,isPending:i}=K(),d=()=>s(void 0,{onSuccess:t.onClose});return e.jsxs(y,{scrollBehavior:"inside",...t,size:"sm",children:[e.jsx(h,{}),e.jsxs(u,{children:[e.jsx(g,{children:"Create Liteserver?"}),e.jsx(j,{py:0,children:e.jsx(a,{textStyle:"body2",color:"text.secondary",children:"Will be created a two Liteserver nodes on free tier with 0.1 RPS. You can change the tier later."})}),e.jsxs(E,{gap:"3",children:[e.jsx(b,{flex:1,onClick:t.onClose,variant:"secondary",children:"Cancel"}),e.jsx(b,{flex:1,isLoading:i,onClick:d,type:"submit",variant:"primary",children:"Create"})]})]})]})},H=t=>`{
  "@type": "config.global",
  "dht": {
...
}`,U=({liteproxyList:t})=>{const s=n=>{const r=n.split(".").map(Number);if(r.length!==4||r.some(c=>c<0||c>255||isNaN(c)))throw new Error("Invalid IP address");const l=BigInt(r[0])<<24n|BigInt(r[1])<<16n|BigInt(r[2])<<8n|BigInt(r[3]),p=BigInt.asIntN(32,l);return Number(p)},i=()=>{const n=t.map(({server:r,public_key:l})=>({ip:s(r.split(":")[0]),port:parseInt(r.split(":")[1]),id:{"@type":"pub.ed25519",key:l}}));return H(JSON.stringify(n,null,2))},d=()=>{const n=i(),r=new Blob([n],{type:"application/json"}),l=URL.createObjectURL(r),p=document.createElement("a");p.href=l,p.download="global.config.json",p.click(),URL.revokeObjectURL(l)};return e.jsx(b,{leftIcon:e.jsx(N,{}),onClick:d,variant:"secondary",children:"Download global.config"})},Q=({onStatisticsClick:t})=>{const{data:s=[]}=P();return e.jsxs(e.Fragment,{children:[s.map((i,d)=>e.jsxs(o,{direction:"column",gap:1,mb:4,children:[e.jsxs(a,{textStyle:"text.label1",fontWeight:600,children:["Server #",d+1]}),e.jsxs(o,{align:"baseline",gap:2,children:[e.jsx(a,{textStyle:"text.label2",children:"Server:"}),e.jsx(A,{text:i.server,variant:"flat",width:"190px"})]}),e.jsxs(o,{align:"baseline",gap:2,children:[e.jsx(a,{textStyle:"text.label2",children:"Public key:"}),e.jsx(A,{text:i.public_key,variant:"flat",width:"407px"})]})]},i.server)),e.jsxs(o,{gap:2,mt:4,children:[e.jsx(U,{liteproxyList:s}),t&&e.jsx(b,{onClick:t,variant:"secondary",children:"Statistics"})]})]})},Y=({onOpenCreate:t})=>e.jsxs(J,{title:"Liteservers",mainButtonAction:t,mainButtonText:"Create Liteserver",guideButtonLink:_.DOCUMENTATION_LITESERVERS,isBeta:!0,children:[e.jsx(a,{textStyle:"body2",children:"The LiteServers service allows you to create and gain direct access to LiteServers in the TON network."}),e.jsx(a,{textStyle:"body2",mt:4,children:"Enjoy seamless access to TON blockchain data without the complexity and overhead of full synchronization on your infrastructure."})]}),ie=()=>{const{isOpen:t,onOpen:s,onClose:i}=M(),{isOpen:d,onOpen:n,onClose:r}=M(),{data:l=[],isLoading:p}=P(),{data:c}=q();return p?e.jsx(m,{h:"300px",children:e.jsx(I,{})}):l.length===0?e.jsxs(e.Fragment,{children:[e.jsx(Y,{onOpenCreate:s}),";",e.jsx(G,{isOpen:t,onClose:i})]}):e.jsxs(e.Fragment,{children:[e.jsxs(F,{h:"fit-content",children:[e.jsxs(o,{gap:4,mb:"4",children:[e.jsxs(o,{direction:"column",gap:2,children:[e.jsxs(o,{align:"center",gap:4,children:[e.jsx(O,{children:"Liteservers"}),e.jsx(X,{textStyle:"label3",color:"accent.orange",fontFamily:"body",bgColor:"color-mix(in srgb, currentColor 12%, transparent)",children:"BETA"})]}),e.jsxs(o,{align:"baseline",gap:2,children:[e.jsxs(a,{textStyle:"text.body2",color:"text.secondary",fontSize:14,children:["Your current plan:"," ",c?`${c.name} (${c.rps} RPS)`:"..."]}),e.jsx(T,{as:z,ml:"auto",color:"accent.blue",to:"./pricing",children:"Change"})]})]}),e.jsx(D,{ml:"auto",leftIcon:e.jsx(R,{w:"20px",h:"20px"}),size:"md",height:"100%",variant:"secondary",href:_.DOCUMENTATION_LITESERVERS,isExternal:!0,children:"Liteservers Doc"})]}),e.jsx(Q,{onStatisticsClick:n})]}),e.jsx(W,{isOpen:d,onClose:r})]})};export{ie as default};
