...
export type DTOCocoonApiPaymentMeta = object;
...
export type DTOChatGptRequestPaymentMeta = object;

export type DTOOtherMeta = object;
...
> extends HttpClient<SecurityDataType> {
  ...
  api = {
     ...
     *
     * @tags tonapi_service
     * @name ValidChangeLiteproxyTier
     * @summary Valid change Liteserver tier for project
     * @request GET:/api/v1/services/tonapi/liteproxy/tier/valid/buy/{id}
     */
    validChangeLiteproxyTier: (
      ...
      >({
        path: `/api/v1/services/tonapi/liteproxy/tier/valid/buy/${id}`,
        method: "GET",
        query: query,
        ...params,
      }),
