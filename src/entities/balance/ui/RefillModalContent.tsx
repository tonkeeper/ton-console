import { FC, useMemo, useRef, useState, useEffect, useId } from 'react';
import {
    Box,
    Button,
    Center,
...
const RefillModalContent: FC<{
    ...
    const paymentLink = useMemo(() => {
        ...
        if (mode === 'TON' && !tonDepositWallet) return null;
    ...
    }, [mode, amount, usdtDepositWallet, tonDepositWallet]);
                                ...
                                <InputGroup mb="4">
                                    <Input
                                        ...
                                        onChange={e => {
                                            ...
                                            if (
                                                symbols &&
                                                symbols > CURRENCY_DECIMALS[mode as Currency]
                                            ) {
                                                return;
                                            }
