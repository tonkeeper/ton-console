...
const PurchaseDialog: FC<PurchaseDialogProps> = observer(
    ({ isOpen, onClose, tier, title, isLoading, onConfirm }) => {
            ...
            <Modal isOpen={isOpen} onClose={onClose} scrollBehavior="inside" size="md">
                ...
                <ModalContent>
                    ...
                    <ModalBody py="0">
                        ...
                        {unspentMoney && priceAfterUnspentMoney.amount.isNegative() && isMonthlyTier && (
